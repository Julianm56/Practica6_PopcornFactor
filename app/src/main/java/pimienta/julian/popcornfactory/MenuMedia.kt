...
class MenuMedia : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_menu_media)
        ...
        gridViewS.adapter = adapterS
        gridViewP.adapter = adapterP
...
class PeliculaAdapter: BaseAdapter {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        var imagen_pelicula = vista.findViewById(R.id.peliculaIMG) as ImageView
        var titulo_pelicula = vista.findViewById(R.id.peliculaTitulo) as TextView

        imagen_pelicula.setImageResource(pelicula.image)
        titulo_pelicula.setText(pelicula.titulo)

        imagen_pelicula.setOnClickListener() {
